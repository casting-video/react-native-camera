...
RCT_EXPORT_VIEW_PROPERTY(onRecording, RCTDirectEventBlock);
...
{
    return @[@"onCameraReady", @"onRecording", @"onMountError", @"onBarCodeRead", @"onFacesDetected", @"onPictureSaved", @"onTextRecognized"];
}
